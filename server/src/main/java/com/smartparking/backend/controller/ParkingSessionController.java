...
public class ParkingSessionController {
    ...
    @PostMapping("/entry")
    public ResponseEntity<ParkingSession> createSession(@RequestBody CreateSessionRequest request) {
        ParkingSession createdSession = service.createSession(request);
